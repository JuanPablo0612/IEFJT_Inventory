...
fun AddTypeScreen(
    ...
    Scaffold(
        topBar = {
            AddTypeTopBar(navigateBack = navigateBack)
        },
        ...
        Column(
            ...
            AnimatedVisibility(
                ...
                TextField(
                    ...
                    label = {
                        Text(text = stringResource(R.string.type_image_url_label))
                    },
                    leadingIcon = {
                        Icon(
            ...
            TextField(
                ...
                label = {
                    Text(text = stringResource(R.string.type_name_label))
                },
                leadingIcon = {
                    Icon(
                ...
                supportingText = if (!uiState.nameValid) {
                    { Text(text = stringResource(R.string.type_name_error)) }
                } else {
                    null
                },
                modifier = Modifier.fillMaxWidth()
